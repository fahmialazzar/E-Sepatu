    ...
    <div class="row">
        <div class="col">
            <div class="card shadow mt-4">
                ...
                <div class="card-body">
                    <form action="<?= base_url('panel/produkmasukedit/' . $id) ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="supplier" value="<?= $row->supplier ?>">
                        </div>
                        <br>
                        <table class="table table-bordered table-striped" id="tabelform">
                            <?php
                            $ambilpembelian = $this->db->table('produkmasuk')->join('produk', 'produkmasuk.idproduk = produk.idproduk')->get()->getResult();
                            $no = 1;
                                        ...
                                        <div class="form-group idprodukharga">
                                            ...
                                            <select name="idproduk[]" id="" data-width="100%" class="form-control idproduk selectcari" required>
                                                ...
                                                <?php foreach ($produk as $data) { ?>
                                                    <option <?php if ($pembelian->idproduk == $data->idproduk) echo 'selected'; ?> value="<?= $data->idproduk ?>"><?= $data->namaproduk ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                    </td>
